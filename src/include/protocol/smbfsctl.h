...
#define FSCTL_QUERY_NETWORK_INTERFACE_INFO 0x001400FC
...
/* Phase 7: MS-RSVD (Remote Shared Virtual Disk) FSCTL codes */
#define FSCTL_QUERY_SHARED_VIRTUAL_DISK_SUPPORT 0x00090300
#define FSCTL_SVHDX_SYNC_TUNNEL_REQUEST         0x00090304
#define FSCTL_SVHDX_ASYNC_TUNNEL_REQUEST        0x00090364
#define FSCTL_QUERY_ON_DISK_VOLUME_INFO         0x009013C0

/* POSIX/WSL extension FSCTL codes */
#define FSCTL_QUERY_POSIX_WHOAMI     0xC01401BA /* POSIX extensions §3.3.5 */
