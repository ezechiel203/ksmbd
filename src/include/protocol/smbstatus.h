...
#define STATUS_HASH_NOT_SUPPORTED cpu_to_le32(0xC000A100)
#define STATUS_HASH_NOT_PRESENT cpu_to_le32(0xC000A101)
#define STATUS_INVALID_TOKEN cpu_to_le32(0xC0000148)
