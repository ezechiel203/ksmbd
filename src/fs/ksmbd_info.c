					  ...
					  unsigned int *out_len)
{
	...
	/*
	 * FILE_NORMALIZED_NAME_INFORMATION is only valid for SMB 3.1.1
	 * and later (MS-SMB2 2.2.37).  Return -ENOSYS for earlier
	 * dialects, which the caller maps to STATUS_NOT_SUPPORTED.
	 */
