						       ...
						       const char *name)
{
	...
	/* M-10: extract caching mode from netlink flags bits 21-22 and
	 * translate to SMB2 ShareFlags caching bits [5:4] (MS-SMB2 §2.2.10).
	 * KSMBD bits 21-22 -> SMB2 ShareFlags: 00=MANUAL(0x00), 01=AUTO(0x10),
	 * 10=VDO(0x20), 11=NONE(0x30).
	 */
	...
	case KSMBD_SHARE_FLAG_CACHING_NONE:
		...
		break;
	default: /* KSMBD_SHARE_FLAG_CACHING_MANUAL or unset */
		share->offline_caching_mode = 0x00000000; /* SMB2_SHAREFLAG_MANUAL_CACHING */
		break;
	}
