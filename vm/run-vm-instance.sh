...
HOST_QUIC_PORT="$(vm_quic_port "$VM_NAME")"
...
echo "  QUIC/proxy: localhost:${HOST_QUIC_PORT} -> 443 (tcp+udp)"
...
exec qemu-system-x86_64 \
    ...
    -netdev "user,id=net0,hostfwd=tcp::${HOST_SMB_PORT}-:445,hostfwd=tcp::${HOST_QUIC_PORT}-:443,hostfwd=udp::${HOST_QUIC_PORT}-:443,hostfwd=tcp::${HOST_SSH_PORT}-:22" \
